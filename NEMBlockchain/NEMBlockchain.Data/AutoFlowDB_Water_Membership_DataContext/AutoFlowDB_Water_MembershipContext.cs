...
{
    public partial class AutoFlowDB_Water_MembershipContext : DbContext
    {
        public AutoFlowDB_Water_MembershipContext(DbContextOptions<AutoFlowDB_Water_MembershipContext> options)
            : base(options)
        {
        }
